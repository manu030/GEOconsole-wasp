...
async function saveSuccessfulOneTimePayment(session, prismaUserDelegate) {
    ...
    return updateUserStripePaymentDetails({ userStripeId, numOfCreditsPurchased, datePaid: new Date() }, prismaUserDelegate);
}
...
async function saveActiveSubscription(invoice, prismaUserDelegate) {
    ...
    return updateUserStripePaymentDetails({ userStripeId, datePaid, subscriptionPlan, subscriptionStatus: SubscriptionStatus.Active }, prismaUserDelegate);
}
