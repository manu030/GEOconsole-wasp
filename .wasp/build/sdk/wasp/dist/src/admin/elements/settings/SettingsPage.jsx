                ...
                <form onSubmit={handleSubmit}>
                  <div className='mb-5.5 flex flex-col gap-5.5 sm:flex-row'>
                    <div className='w-full sm:w-1/2'>
                      ...
                      <div className='relative'>
                        ...
                        <Input className='pl-11.5' type='text' name='fullName' id='full-name' placeholder='Devid Jhon' defaultValue='Devid Jhon'/>
                      </div>
                    </div>

                    <div className='w-full sm:w-1/2'>
                      <Label htmlFor='phone-number' className='mb-3 block text-sm font-medium text-foreground'>
                        Phone Number
                      </Label>
                      <Input type='' name='phoneNumber' id='phone-number' placeholder='+990 3343 7865' defaultValue='+990 3343 7865'/>
                    </div>
                  </div>
                  ...
                  <div className='mb-5.5'>
                    ...
                    <div className='relative'>
                      ...
                      <Input className='pl-11.5' type='email' name='emailAddress' id='email-address' placeholder='devidjond45@gmail.com' defaultValue='devidjond45@gmail.com'/>
                    </div>
                  </div>
                  ...
                  <div className='mb-5.5'>
                    ...
                    <Input type='text' name='Username' id='username' placeholder='devidjhon24' defaultValue='devidjhon24'/>
                  </div>
                  ...
                  <div className='mb-5.5'>
                    ...
                    <div className='relative'>
                      ...
                      <Textarea className='w-full rounded border border-border bg-background py-3 pl-11.5 pr-4.5 text-foreground focus:border-primary focus-visible:outline-none' name='bio' id='bio' rows={6} placeholder='Write your bio here' defaultValue='Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque posuere fermentum urna, eu condimentum mauris tempus ut. Donec fermentum blandit aliquet.'></Textarea>
                    </div>
                  </div>
            ...
            <Card>
              ...
              <CardContent>
                <form action='#'>
                  ...
                  <div id='FileUpload' className='relative mb-5.5 block w-full cursor-pointer appearance-none rounded border-2 border-dashed border-primary bg-background py-4 px-4 sm:py-7.5'>
