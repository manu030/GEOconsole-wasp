    ...
    return (<Card>
      ...
      <CardContent className='flex justify-between'>
        ...
        <span className={cn('flex items-center gap-1 text-sm font-medium', {
            'text-success': isDeltaPositive && prevDayViewsChangePercent && prevDayViewsChangePercentValue !== 0,
            'text-destructive': !isDeltaPositive && prevDayViewsChangePercent && prevDayViewsChangePercentValue !== 0,
