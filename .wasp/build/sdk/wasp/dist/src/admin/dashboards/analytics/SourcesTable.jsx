const SourcesTable = ({ sources }) => {
    return (<div className='rounded-sm border border-border bg-card px-5 pt-6 pb-2.5 shadow-default sm:px-7.5 xl:pb-1'>
      ...
      <div className='flex flex-col'>
        ...
        {sources && sources.length > 0 ? (sources.map((source) => (<div className='grid grid-cols-3 border-b border-border'>
...
//# sourceMappingURL=SourcesTable.jsx.map