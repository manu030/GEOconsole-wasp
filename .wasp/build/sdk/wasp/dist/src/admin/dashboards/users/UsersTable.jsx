      ...
      <div className='rounded-sm border border-border bg-card shadow'>
        <div className='flex-col flex items-start justify-between p-6 gap-3 w-full bg-muted/40'>
          ...
          <div className='flex items-center justify-between gap-3 w-full px-2'>
                  ...
                  <SelectContent className='w-[300px]'>
                    <div className='p-2'>
                      <div className='flex items-center justify-between mb-2'>
                        ...
                        {subscriptionStatusFilter.length > 0 && (<button onClick={clearAllStatusFilters} className='text-xs text-muted-foreground hover:text-foreground'>
                            Clear all
                          </button>)}
                      </div>
            ...
            {data?.totalPages && (<div className='max-w-60 flex flex-row items-center'>
          ...
          {hasActiveFilters && (<div className='flex items-center gap-2 px-2 pt-2 border-border'>
        ...
        {!!data?.users &&
            data?.users?.length > 0 &&
            data.users.map((user) => (<div key={user.id} className='grid grid-cols-9 gap-4 py-4.5 px-4 md:px-6 '>
              <div className='col-span-3 flex items-center'>
