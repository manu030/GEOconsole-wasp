...
import { CREDIT_TRANSACTION_OPTIONS } from '../utils/database-config';
/**
 ...
 */
export const withVisibilityAnalysisCredit = async (userId, operationName, operation) => {
 ...
 */
export const withContentGenerationCredit = async (userId, operationName, operation) => {
    const correlationId = generateCorrelationId();
 ...
 */
export const checkUserCreditsForOperation = async (userId, operationType) => {
 ...
 */
export const getCreditCost = (operationType) => {
