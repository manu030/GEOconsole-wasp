 ...
 */
export const createInsufficientCreditsError = (requiredCredits, availableCredits, correlationId) => {
    ...
    httpError.type = 'INSUFFICIENT_CREDITS';
    httpError.requiredCredits = requiredCredits;
    httpError.availableCredits = availableCredits;
    httpError.correlationId = correlationId;
    httpError.retryable = false; // User needs to purchase more credits
    return httpError;
};
/**
 * Creates a generic credit-related error with correlation ID
 */
export const createCreditError = (message, statusCode = 400, correlationId) => {
    if (correlationId) {
