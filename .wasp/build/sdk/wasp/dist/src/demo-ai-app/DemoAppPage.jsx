        ...
        {tasks && tasks.length > 0 ? (<div className='space-y-4'>
            ...
            <div className='flex flex-col gap-3'>
              <div className='flex items-center justify-between gap-3'>
                ...
                <Input type='number' id='time' step={0.5} min={1} max={24} className='min-w-[7rem] text-center' value={todaysHours} onChange={(e) => setTodaysHours(+e.currentTarget.value)}/>
              </div>
            </div>
          </div>) : (<div className='text-muted-foreground text-center'>Add tasks to begin</div>)}
      </div>
      ...
      <div className='flex items-center justify-between w-full'>
        <div className='flex items-center justify-between gap-5 w-full'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <span className={cn('italic text-muted-foreground text-xs', {
        ...
        <div className='flex items-center justify-end w-15'>
          <Button variant='ghost' size='sm' onClick={handleDeleteClick} title='Remove task' className='p-1 h-auto text-destructive hover:text-destructive/80'>
            <Trash2 size='20'/>
          </Button>
        </div>
      </div>
      ...
      <div className='space-y-4'>
        {!!schedule.tasks ? (schedule.tasks
            ...
            if (a.props.task.priority && b.props.task.priority) {
                return (priorityOrder.indexOf(b.props.task.priority) - priorityOrder.indexOf(a.props.task.priority));
            }
            else {
                return 0;
            }
...
function TaskCardItem({ description, time }) {
    ...
    return (<li className='flex items-center justify-between gap-4 p-2 rounded-md'>
      <div className='flex items-center gap-3 flex-1'>
        ...
        <span className={cn('leading-tight text-sm', {
